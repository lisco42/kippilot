...
class SunnylinkLayout(Widget):
  ...
  def _handle_backup_btn(self):
    backup_dialog = ConfirmDialog(text=tr("Are you sure you want to backup your current kippilot settings?"), confirm_text="Backup",
  ...
  def _handle_restore_btn(self):
    ...
    restore_dialog = ConfirmDialog(text=tr("Are you sure you want to restore the last backed up kippilot settings?"),
